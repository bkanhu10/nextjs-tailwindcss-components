  ...
  const fetchProducts = useCallback(
    async (page, filters) => {
      ...
      try {
        ...
        const res = await getAllTiles(`${queryParams.toString()}`);
        const { count, totalPages } = res?.data;
        const products = res?.data?.tiles;
        setData(products);
        setPagination({
          count,
...
export default useTileProducts;
